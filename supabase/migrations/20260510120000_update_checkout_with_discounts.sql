-- Update checkout_v1 function to support discounts (Phase 7)
...
BEGIN
  ...
  IF p_discount_code_id IS NOT NULL AND p_discount_amount > 0 THEN
...
GRANT EXECUTE ON FUNCTION public.checkout_v1(UUID, JSONB, payment_method, delivery_type, TEXT, TEXT, TEXT, UUID, NUMERIC) TO authenticated;
